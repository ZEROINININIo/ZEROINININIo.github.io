...
<head>
  ...
  <link rel="stylesheet" id="patternfly-adjusted-css" href="/assets/css/app.css" type="text/css" media="all">
    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" id="logo" title="<?php echo $conf['sitename']?>" href="/">
...
echo '<li><a href="'.$res['url'].'">'.$res['name'].'';
  ...
  <div class="jumbotron">
    <div class="container">
      <div class="splash">
        <div class="content">
          <img src="http://q.qlogo.cn/headimg_dl?dst_uin=<?php echo $conf['kfqq']?>&spec=640" alt="PatternFly logo" id="qq" class="wow fadeInDown animated"
...
while($res = $DB->fetch($rs))
{
echo '<a href="'.$res['url'].'" class="button button-glow button-border button-rounded button-primary" >'.$res['name'].'</a>&nbsp&nbsp&nbsp&nbsp';
}
        ?>  
...
<script src="/assets/js/hovertreewelcome.js"></script>
