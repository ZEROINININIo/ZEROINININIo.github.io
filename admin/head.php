  ...
  <div class="lyear-layout-container">
    <aside class="lyear-layout-sidebar">
      <div id="logo" class="sidebar-header">
        <a href="index.php"><img src="../images/logo.png" title="网友禁轩制作" alt="网友禁轩制作" /></a>
      </div>
      <div class="lyear-layout-sidebar-scroll"> 
        <nav class="sidebar-main">
          <ul class="nav nav-drawer">
            ...
            <li class="nav-item"> 
            <a href="http://wpa.qq.com/msgrd?v=3&uin=536487561&site=qq&menu=yes">
        ...
        <div class="sidebar-footer">
          <p class="copyright">Copyright &copy; 2020. <a target="_blank" href=""><?php echo $conf['sitename']; ?></a></p>
        </div>
      </div>
    </aside>
