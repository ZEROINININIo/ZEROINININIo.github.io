import{c as S,j as e,H as ae,e as $,C as se,r as w,f as Y,a as G,L as ie,g as y,d as oe,X as Z,D as ne}from"./index-MKo_SsHn.js";import{R as k}from"./Reveal-DndMB4Yr.js";import{S as re,s as M,H as le,B as de}from"./sideCharacters-BjaSYWRC.js";import{L as H}from"./lock-pcZXjybf.js";import{A as X,F as K,C as q,L as he,E as ce}from"./list-B-0y1xNT.js";import{M as ue}from"./MaskedText-e-rUsTeK.js";import{I as me}from"./image-C0yGH-ZH.js";import{F as pe}from"./folder-open-P4YMxRbl.js";const be=S("Binary",[["rect",{x:"14",y:"14",width:"4",height:"6",rx:"2",key:"p02svl"}],["rect",{x:"6",y:"4",width:"4",height:"6",rx:"2",key:"xm4xkj"}],["path",{d:"M6 20h4",key:"1i6q5t"}],["path",{d:"M14 10h4",key:"ru81e7"}],["path",{d:"M6 14h2v6",key:"16z9wg"}],["path",{d:"M14 4h2v6",key:"1idq9u"}]]),ge=S("Clock",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["polyline",{points:"12 6 12 12 16 14",key:"68esgv"}]]),J=S("CloudRain",[["path",{d:"M4 14.899A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.5 8.242",key:"1pljnt"}],["path",{d:"M16 14v6",key:"1j4efv"}],["path",{d:"M8 14v6",key:"17c4r9"}],["path",{d:"M12 16v6",key:"c8a4gj"}]]),Q=S("Folder",[["path",{d:"M20 20a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.9a2 2 0 0 1-1.69-.9L9.6 3.9A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2Z",key:"1kt360"}]]),xe=S("Sparkle",[["path",{d:"m12 3-1.9 5.8a2 2 0 0 1-1.287 1.288L3 12l5.8 1.9a2 2 0 0 1 1.288 1.287L12 21l1.9-5.8a2 2 0 0 1 1.287-1.288L21 12l-5.8-1.9a2 2 0 0 1-1.288-1.287Z",key:"nraa5p"}]]),ee=S("Star",[["polygon",{points:"12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2",key:"8f66p6"}]]),fe=S("VenetianMask",[["path",{d:"M2 12a5 5 0 0 0 5 5 8 8 0 0 1 5 2 8 8 0 0 1 5-2 5 5 0 0 0 5-5V7h-5a8 8 0 0 0-5 2 8 8 0 0 0-5-2H2Z",key:"1g6z3j"}],["path",{d:"M6 11c1.5 0 3 .5 3 2-2 0-3 0-3-2Z",key:"c2lwnf"}],["path",{d:"M18 11c-1.5 0-3 .5-3 2 2 0 3 0 3-2Z",key:"njd9zo"}]]),ye={id:"story-frag-rain-1",date:"档案记录: S-001",status:"published",translations:{"zh-CN":{title:"那场仍未结束的零碎之雨 (一) // 废墟",summary:"废弃的校区，久违的吉他话题，以及掩盖在日常下的暗流。",content:`[[BLUE::记忆提取中... 场景重构：废弃校区]]
...
Dusk: "...Oh? Finally talking shop? Let's go!"`}}},we={id:"story-frag-rain-2",date:"档案记录: S-002",status:"published",translations:{"zh-CN":{title:"那场仍未结束的零碎之雨 (二) // 揭露",summary:"厚重的气密门隔绝了通路，也锁住了那些关于“实验”的秘密。",content:`[[BLUE::记忆提取中... 场景重构：Nova Labs 内部实验室 - B区 (Sector B)]]
...
[[IMAGE::https://free.picui.cn/free/2025/12/08/6936e856897d6.png::PHOTO_ARCHIVE_M001]]`}}},ve={id:"story-frag-rain-3",date:"档案记录: S-003",status:"published",translations:{"zh-CN":{title:"那场仍未结束的零碎之雨 (三) // 托付",summary:"黄昏的吉他声掩盖了真相，怀表的滴答声倒数着离别。",content:`[[BLUE::记忆提取中... 场景重构：未完工观景台]]
...
[[BLUE::[DATA RECORD INTERRUPTED...]]] `}}},ke={id:"story-frag-rain-4",date:"档案记录: S-004",status:"published",translations:{"zh-CN":{title:"那场仍未结束的零碎之雨 (四) // 真相",summary:"既然结局无法更改，那么知晓真相便是我最后的执念。",content:`[[BLUE::记忆提取中... 场景重构：深夜的星联办公室]]
...
[[BLUE::[TRUTH ARCHIVED.] ]]`}}},Ie={id:"story-coffee-crisis",date:"档案记录: X-001",status:"published",translations:{"zh-CN":{title:"咖啡机改造计划",summary:"芷漓觉得实验室的咖啡机效率太低，于是动手进行了“微调”。",content:`[[DIVIDER]]
...
Zeri: "...Is that really necessary?" (Calmly presses the button, causing the entire lab's lights to dim)`}}},Ne={id:"story-quantum-delivery",date:"档案记录: X-002",status:"published",translations:{"zh-CN":{title:"高维快递服务",summary:"零点试图证明“空间折跃”可以用于外卖配送，但收货地址似乎填错到了奇怪的地方。",content:`[[DIVIDER]]
...
Zelo: "(Whispering) In a sense, this really is a 'High-Dimensional' delivery..."`}}},je={id:"story-hotpot-protocol",date:"档案记录: X-003",status:"published",translations:{"zh-CN":{title:"绝密火锅协议",summary:"实验室守则第一条：严禁在操作台附近饮食。除非……食材实在是太诱人了。",content:`[[DIVIDER]]
...
Point: "Aaaah! My beef! No one grab it, I'm going to turn my grief and indignation into appetite!"`}}},Ee={id:"special-legacy-dusk",date:"F-6年34月13日",status:"published",translations:{"zh-CN":{title:"legacy",summary:"数据流深处的一封未发送信件。发件人：D.雨",content:`[[DANGER::【系统提示：该文件已自动设置为只读状态】]]
       ...
       I'm really glad to have met you, Point. Thanks to you, I had the chance to know why my parents died, but it's a pity I can only thank you here. I'm sorry to die in your lab like this, I guess X_bot will clean it up. Anyway, Point-chan, you must live well for me. You can miss me, but don't come looking for me (lol).
                                                             ...
                                                             Year F-6, Month 34, Day 13                                                                  
                                                                          D.Rain`}}},De=(r,c)=>({id:r,date:c,status:"locked",translations:{"zh-CN":{title:"▞▞▞▞▞▞",content:"",summary:"FILE_CORRUPTED"},"zh-TW":{title:"▞▞▞▞▞▞",content:"",summary:"FILE_CORRUPTED"},en:{title:"▞▞▞▞▞▞",content:"",summary:"FILE_CORRUPTED"}}}),Se=[{id:"VOL_MEMORIES",title:"那场仍未结束的零碎之雨",titleEn:"The Fragmented Rain That Never Ended",status:"unlocked",chapters:[ye,we,ve,ke,Ee]},{id:"VOL_DAILY",title:"时域日常",titleEn:"Time Line Daily",status:"unlocked",chapters:[Ie,Ne,je,De("ERR_004","档案记录: X-004")]},{id:"VOL_UNKNOWN",title:"▓▓▓▓▓▓",titleEn:"UNKNOWN_SECTOR",status:"corrupted",chapters:[]}],ze=({volumes:r,onSelectVolume:c,onOpenCharModal:u,language:t,isLightTheme:s})=>e.jsxs("div",{className:"h-full bg-halftone overflow-y-auto p-4 md:p-12 relative flex flex-col items-center",children:[e.jsxs("div",{className:"fixed top-0 left-0 w-full h-full pointer-events-none opacity-20",children:[e.jsx("div",{className:"absolute top-1/4 left-0 w-full h-px bg-ash-gray/50"}),e.jsx("div",{className:"absolute bottom-1/4 left-0 w-full h-px bg-ash-gray/50"}),e.jsx("div",{className:"absolute top-0 left-1/4 h-full w-px bg-ash-gray/50"}),e.jsx("div",{className:"absolute top-0 right-1/4 h-full w-px bg-ash-gray/50"})]}),e.jsxs("button",{onClick:u,className:"fixed bottom-24 right-4 md:absolute md:top-4 md:right-4 z-50 bg-ash-black border border-ash-gray p-3 text-ash-gray hover:bg-ash-light hover:text-ash-black hover:border-ash-light transition-all shadow-hard group",title:"Personnel Archive",children:[e.jsx(fe,{size:20}),e.jsx("span",{className:"absolute right-full top-1/2 -translate-y-1/2 mr-3 bg-ash-dark text-ash-light text-[10px] font-mono px-2 py-1 opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none border border-ash-gray hidden md:block",children:"PERSONNEL_DB"})]}),e.jsx("header",{className:"relative z-10 mb-16 text-center w-full max-w-2xl mx-auto mt-8 md:mt-4",children:e.jsxs("div",{className:"flex flex-col items-center gap-3",children:[e.jsx(ae,{size:40,className:"text-ash-light",strokeWidth:1}),e.jsx("h1",{className:"text-3xl md:text-5xl font-black text-ash-light uppercase tracking-tighter glitch-text-heavy","data-text":t==="en"?"SIDE_ARCHIVES":"支线档案库",children:t==="en"?"SIDE_ARCHIVES":"支线档案库"}),e.jsxs("div",{className:"flex items-center gap-2 text-[10px] font-mono text-ash-gray border border-ash-gray/50 px-2 py-1 bg-ash-black/80",children:[e.jsx("span",{className:"w-2 h-2 bg-green-500 rounded-full animate-pulse"}),"STATUS: MOUNTED",e.jsx("span",{className:"mx-1",children:"|"}),"/VAR/LIB/MEMORIES/SIDE_STORIES"]})]})}),e.jsx("div",{className:"w-full max-w-6xl relative z-10 grid grid-cols-1 md:grid-cols-3 gap-8 px-2 md:px-4 pb-20",children:r.map((i,l)=>{const o=i.status==="locked",n=i.status==="corrupted",a=i.id==="VOL_MEMORIES",m=s?"bg-red-50 border-red-300 text-red-700":"bg-red-950/20 border-red-900 text-red-500",p=s?"bg-zinc-200 border-zinc-300 text-zinc-500":"bg-ash-dark/20 border-ash-dark text-ash-gray",v=s?"bg-white border-zinc-300 text-zinc-800 hover:border-zinc-500 hover:shadow-lg":"bg-ash-black/90 border-ash-gray text-ash-light group-hover:border-ash-light group-hover:bg-ash-dark/80 group-hover:shadow-[0_0_20px_rgba(255,255,255,0.1)]",h=s?"bg-sky-50 border-cyan-500 text-sky-900 shadow-[0_0_15px_rgba(6,182,212,0.2)] hover:shadow-[0_0_25px_rgba(6,182,212,0.4)] hover:-translate-y-2":"bg-cyan-950/20 border-cyan-500 text-cyan-400 shadow-[0_0_15px_rgba(6,182,212,0.15)] hover:bg-cyan-900/30 hover:shadow-[0_0_30px_rgba(6,182,212,0.3)] hover:-translate-y-2";return e.jsx(k,{delay:l*150,className:`w-full h-full ${a?"md:col-span-1":""}`,children:e.jsxs("button",{onClick:()=>{!o&&!n&&c(i)},disabled:o||n,className:`
                                    w-full h-64 relative group transition-all duration-300 transform
                                    flex flex-col text-left overflow-hidden
                                    ${n?"opacity-80":o?"opacity-60":"cursor-pointer"}
                                `,children:[e.jsxs("div",{style:{clipPath:"polygon(0 0, 100% 0, 100% 85%, 90% 100%, 0 100%)"},className:`
                                        absolute inset-0 border-2 transition-colors duration-300
                                        ${n?m:o?p:a?h:v}
                                    `,children:[e.jsx("div",{className:`absolute inset-0 bg-transparent bg-[linear-gradient(rgba(18,16,16,0)_50%,rgba(0,0,0,0.25)_50%),linear-gradient(90deg,rgba(255,0,0,0.06),rgba(0,255,0,0.02),rgba(0,0,255,0.06))] z-10 bg-[length:100%_2px,3px_100%] pointer-events-none ${s?"opacity-5":"opacity-20"}`}),a&&e.jsxs(e.Fragment,{children:[!s&&e.jsx("div",{className:"absolute inset-0 bg-gradient-to-br from-cyan-500/10 to-transparent pointer-events-none"}),e.jsx("div",{className:"absolute inset-0 overflow-hidden pointer-events-none opacity-40",children:Array.from({length:12}).map((N,x)=>e.jsx("div",{className:`absolute w-[1.5px] bg-gradient-to-b from-transparent ${s?"via-cyan-600":"via-cyan-300"} to-transparent`,style:{height:`${20+Math.random()*40}%`,left:`${Math.random()*100}%`,top:"-20%",animation:`dataRainCard ${1.5+Math.random()*1.5}s linear infinite`,animationDelay:`${Math.random()*2}s`,willChange:"transform"}},x))})]}),a&&e.jsxs("div",{className:`absolute top-0 right-0 z-30 px-3 py-1 text-[10px] font-bold font-mono border-b-2 border-l-2 flex items-center gap-1 ${s?"bg-cyan-100 text-cyan-700 border-cyan-200":"bg-cyan-950 text-cyan-400 border-cyan-500/50"}`,children:[e.jsx(re,{size:10,className:"animate-pulse"}),"FEATURED"]}),e.jsxs("div",{className:"p-6 h-full flex flex-col relative z-20",children:[e.jsxs("div",{className:"flex justify-between items-start mb-auto",children:[a?e.jsxs("div",{className:"relative",children:[e.jsx(J,{size:32,strokeWidth:1,className:"text-cyan-500 relative z-10"}),e.jsx(ee,{size:16,className:"text-cyan-300 absolute -top-1 -right-1 animate-spin-slow"})]}):e.jsx(Q,{size:32,strokeWidth:1,className:n?"animate-pulse":""}),e.jsxs("div",{className:"text-[10px] font-mono border border-current px-1 opacity-70",children:["VOL_0",l+1]})]}),e.jsxs("div",{className:"space-y-1 mt-4",children:[e.jsx("h3",{className:`font-black text-xl md:text-2xl font-mono uppercase tracking-tight leading-none ${n?"blur-[1px]":""} ${a?s?"text-cyan-700":"text-cyan-100 drop-shadow-[0_0_5px_rgba(6,182,212,0.8)]":""}`,children:t==="en"?i.titleEn:i.title}),e.jsx("div",{className:`text-[10px] font-mono uppercase tracking-widest ${a?"opacity-80":"opacity-50"}`,children:i.titleEn})]}),e.jsxs("div",{className:"mt-6 pt-4 border-t border-dashed border-current/30 flex justify-between items-end text-[10px] font-mono",children:[e.jsxs("div",{className:"flex flex-col gap-1",children:[e.jsxs("span",{children:["SIZE: ",i.chapters.length*128,"KB"]}),e.jsxs("span",{className:"flex items-center gap-1",children:["STATUS:",n?"ERR":o?"LCK":"RDY"]})]}),n?e.jsx($,{size:16}):o?e.jsx(H,{size:16}):e.jsx("div",{className:"w-16 h-2 bg-current opacity-20 relative",children:e.jsx("div",{className:"absolute left-0 top-0 h-full bg-current w-1/2"})})]})]})]}),!o&&!n&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:`absolute top-0 left-0 w-4 h-4 border-t-2 border-l-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 ${a?"border-cyan-400":s?"border-zinc-800":"border-ash-light"}`}),e.jsx("div",{className:`absolute bottom-0 right-0 w-4 h-4 border-b-2 border-r-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 ${a?"border-cyan-400":s?"border-zinc-800":"border-ash-light"}`})]})]})},i.id)})})]}),_e=({volume:r,onBack:c,onSelectChapter:u,language:t,isLightTheme:s})=>e.jsx("div",{className:"h-full bg-halftone overflow-y-auto p-4 md:p-12 relative flex flex-col items-center",children:e.jsxs("div",{className:"w-full max-w-3xl relative z-10 animate-fade-in mt-8 md:mt-0",children:[e.jsxs("div",{className:"flex items-center gap-4 mb-8 border-b-2 border-ash-gray pb-4",children:[e.jsx("button",{onClick:c,className:"p-2 border border-ash-gray text-ash-gray hover:text-ash-light hover:border-ash-light hover:bg-ash-dark transition-all",children:e.jsx(X,{size:20})}),e.jsxs("div",{children:[e.jsxs("div",{className:"text-[10px] font-mono text-ash-gray",children:["ROOT / ",r.id]}),e.jsx("h2",{className:"text-2xl font-black text-ash-light uppercase tracking-tight",children:t==="en"?r.titleEn:r.title})]}),e.jsx("div",{className:"ml-auto hidden md:block",children:e.jsx(se,{size:24,className:"text-ash-dark animate-pulse"})})]}),e.jsx("div",{className:"space-y-3",children:r.chapters.map((i,l)=>{const o=i.status==="locked",n=i.translations[t]||i.translations["zh-CN"],a=i.id==="special-legacy-dusk";let m="";return a?m=s?"bg-blue-50/80 border-blue-500 text-blue-900 shadow-[0_0_15px_rgba(37,99,235,0.4)] border-dashed animate-shake-violent skew-x-2":"bg-blue-950/30 border-blue-400 text-blue-400 shadow-[0_0_20px_rgba(96,165,250,0.4)] border-dashed animate-shake-violent -skew-x-1":o?m=s?"bg-zinc-100 border-zinc-300 text-zinc-400 opacity-60 cursor-not-allowed":"bg-ash-dark/20 border-ash-dark/50 text-ash-gray opacity-60 cursor-not-allowed":m=s?"bg-white border-zinc-300 text-zinc-800 hover:bg-zinc-50 hover:border-zinc-500 shadow-sm":"bg-ash-black/80 border-ash-dark/50 text-ash-light hover:border-ash-light hover:bg-ash-dark/40 shadow-hard-sm",e.jsx(k,{delay:l*50,children:e.jsxs("button",{onClick:()=>{o||u(l)},disabled:o,className:`
                                        w-full flex items-center gap-4 p-4 border transition-all duration-200 group relative overflow-hidden
                                        ${m}
                                        ${a?"hover:scale-[1.01] hover:bg-blue-900/10 cursor-not-allowed":""}
                                    `,children:[e.jsx("div",{className:`shrink-0 w-8 text-center font-mono text-xs ${a?"text-blue-500 font-bold":"opacity-50"}`,children:a?"!!":String(l+1).padStart(2,"0")}),e.jsx("div",{className:`
                                        shrink-0 p-2 border transition-colors
                                        ${a?"bg-blue-950 border-blue-500 text-blue-500 animate-pulse":o?"bg-transparent border-current opacity-50":s?"bg-zinc-100 border-zinc-200 group-hover:bg-zinc-800 group-hover:text-white group-hover:border-zinc-800":"bg-ash-dark/50 border-ash-gray/30 group-hover:border-ash-light group-hover:bg-ash-light group-hover:text-ash-black"}
                                    `,children:a?e.jsx(ee,{size:16,fill:"currentColor"}):o?e.jsx(H,{size:16}):e.jsx(K,{size:16})}),e.jsxs("div",{className:"flex-1 text-left relative overflow-hidden",children:[e.jsx("div",{className:`font-bold font-mono text-sm md:text-base uppercase truncate ${a?"glitch-text-heavy tracking-widest opacity-80":""}`,"data-text":n.title,children:n.title}),a&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"absolute top-0 left-0 w-full h-full text-blue-300 opacity-50 animate-pulse translate-x-[2px] pointer-events-none mix-blend-overlay",children:n.title}),e.jsx("div",{className:"absolute top-0 left-0 w-full h-full text-white opacity-20 animate-glitch translate-x-[-2px] pointer-events-none mix-blend-color-dodge",children:n.title})]}),e.jsxs("div",{className:`text-[10px] font-mono flex items-center gap-2 ${a?"text-blue-500/70":"opacity-50"}`,children:[e.jsx("span",{children:i.date}),a&&e.jsx("span",{className:"font-bold border border-blue-500/50 px-1 bg-blue-950/30",children:"LEGACY // CORRUPTED"}),!o&&!a&&e.jsxs("span",{className:"hidden md:inline",children:["| ",n.content.length*2," BYTES"]})]})]}),!o&&e.jsx("div",{className:"opacity-0 group-hover:opacity-100 transition-opacity",children:e.jsx(q,{size:16})}),a&&e.jsx("div",{className:"opacity-70 animate-pulse",children:e.jsx($,{size:16,className:"text-blue-500"})}),!o&&!s&&!a&&e.jsx("div",{className:"absolute inset-0 bg-white/5 translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-700 ease-in-out pointer-events-none skew-x-12"}),a&&e.jsx("div",{className:"absolute inset-0 pointer-events-none bg-[repeating-linear-gradient(45deg,transparent,transparent_10px,rgba(59,130,246,0.05)_10px,rgba(59,130,246,0.05)_20px)] animate-[pulse_0.1s_infinite]"})]})},i.id)})})]})}),F=({lines:r})=>{const[c,u]=w.useState(!1);return e.jsx(k,{children:e.jsxs("div",{className:"my-10 border-l-4 border-fuchsia-600 bg-fuchsia-950/10 font-mono text-xs md:text-sm shadow-[0_0_15px_-3px_rgba(192,38,211,0.2)]",children:[e.jsxs("button",{onClick:()=>u(!c),className:"w-full text-left p-3 md:p-4 bg-fuchsia-950/20 hover:bg-fuchsia-900/30 text-fuchsia-300 font-bold flex items-center gap-3 transition-all group border-b border-fuchsia-500/20",children:[e.jsx("div",{className:`transition-transform duration-300 ${c?"rotate-90":""}`,children:e.jsx($,{size:16})}),e.jsxs("div",{className:"flex flex-col md:flex-row md:items-center gap-1 md:gap-3",children:[e.jsx("span",{className:"animate-pulse tracking-widest text-fuchsia-400",children:">>> SYSTEM_INTERCEPT // VOID_SIDE"}),e.jsx("span",{className:"text-[10px] bg-fuchsia-900/50 px-1 border border-fuchsia-500/30 text-fuchsia-200/70",children:"SOURCE: UNKNOWN"})]})]}),e.jsx("div",{className:`transition-all duration-500 ease-in-out overflow-hidden ${c?"max-h-[1000px] opacity-100":"max-h-0 opacity-0"}`,children:e.jsx("div",{className:"p-4 md:p-6 text-fuchsia-100/90 space-y-2 leading-relaxed tracking-wide font-medium bg-black/20 backdrop-blur-sm",children:r.map((t,s)=>e.jsx("p",{className:"border-l border-fuchsia-500/20 pl-3 hover:border-fuchsia-500 hover:bg-fuchsia-500/5 transition-colors duration-300",children:t.replace(/0000\.2Void>>|【插入结束】|【插入結束】|\[INSERTION_END\]/g,"")},s))})})]})})},W=r=>r.split(/(\[\[(?:MASK|GLITCH_GREEN)::.*?\]\])/g).map((u,t)=>{if(u.startsWith("[[MASK::")&&u.endsWith("]]")){const s=u.slice(8,-2);return e.jsx(ue,{children:s},t)}else if(u.startsWith("[[GLITCH_GREEN::")&&u.endsWith("]]")){const s=u.slice(16,-2);return e.jsxs("span",{className:"text-emerald-400 font-black tracking-widest drop-shadow-[0_0_10px_rgba(52,211,153,0.8)] inline-block animate-pulse relative px-1",children:[e.jsx("span",{className:"absolute inset-0 animate-ping opacity-30 blur-sm bg-emerald-500/20 rounded-full"}),e.jsx("span",{className:"relative z-10",children:s})]},t)}return u}),Ce=({volume:r,initialChapterIndex:c,onBack:u,language:t,isLightTheme:s,readerFont:i})=>{const[l,o]=w.useState(c),[n,a]=w.useState(!0),m=w.useRef(null);w.useEffect(()=>{window.innerWidth<768&&a(!1)},[]),w.useEffect(()=>{m.current&&(m.current.scrollTop=0)},[l]);const p=r.chapters[l],v=p.translations[t]||p.translations["zh-CN"],h=p.id==="special-legacy-dusk",N=x=>{const j=d=>d.length===0?"":d.reduce((f,g,A)=>{if(A===0)return g;const C=d[A-1],R=C[C.length-1],V=g[0],_=/[\u3000-\u303f\u3040-\u309f\u30a0-\u30ff\uff00-\uff9f\u4e00-\u9faf\u3400-\u4dbf]/,P=_.test(R),O=_.test(V);return P||O?f+g:f+" "+g},""),z=x.split(`
`),b=[];let E=[],T=!1,D=[];const B=()=>{if(E.length>0){const d=j(E);let f=`mb-6 md:mb-8 text-justify indent-8 md:indent-12 text-sm md:text-base leading-relaxed text-ash-light transition-colors ${y(i)}`;h?f=s?"mb-6 md:mb-8 text-justify indent-8 md:indent-12 font-mono text-sm md:text-base leading-relaxed text-blue-900 legacy-text":"mb-6 md:mb-8 text-justify indent-8 md:indent-12 font-mono text-sm md:text-base leading-relaxed text-blue-200 legacy-text":d.startsWith("零点")||d.startsWith("Point")||d.startsWith("零點")?f=s?`mb-6 md:mb-8 text-justify indent-8 md:indent-12 text-sm md:text-base leading-relaxed text-zinc-600 font-bold ${y(i)}`:`mb-6 md:mb-8 text-justify indent-8 md:indent-12 text-sm md:text-base leading-relaxed text-white drop-shadow-[0_0_2px_rgba(255,255,255,0.4)] ${y(i)}`:d.startsWith("芷漓")||d.startsWith("Zeri")?f=s?`mb-6 md:mb-8 text-justify indent-8 md:indent-12 text-sm md:text-base leading-relaxed text-pink-600 ${y(i)}`:`mb-6 md:mb-8 text-justify indent-8 md:indent-12 text-sm md:text-base leading-relaxed text-pink-400 drop-shadow-[0_0_2px_rgba(244,114,182,0.4)] ${y(i)}`:d.startsWith("泽洛")||d.startsWith("Zelo")||d.startsWith("澤洛")?f=s?`mb-6 md:mb-8 text-justify indent-8 md:indent-12 text-sm md:text-base leading-relaxed text-blue-600 ${y(i)}`:`mb-6 md:mb-8 text-justify indent-8 md:indent-12 text-sm md:text-base leading-relaxed text-blue-400 drop-shadow-[0_0_2px_rgba(96,165,250,0.4)] ${y(i)}`:d.startsWith("???")||d.startsWith("Void")||d.includes("void")||d.includes("Void")?f=s?`mb-6 md:mb-8 text-justify indent-8 md:indent-12 text-sm md:text-base leading-relaxed text-zinc-900 font-bold ${y(i)}`:`mb-6 md:mb-8 text-justify indent-8 md:indent-12 text-sm md:text-base leading-relaxed text-white drop-shadow-[0_0_5px_rgba(255,255,255,0.5)] ${y(i)}`:(d.startsWith("终端")||d.startsWith("TERMINAL")||d.startsWith("終端"))&&(f=s?"mb-6 md:mb-8 text-justify indent-8 md:indent-12 font-mono text-sm md:text-base leading-relaxed text-emerald-700 font-bold":"mb-6 md:mb-8 text-justify indent-8 md:indent-12 font-mono text-sm md:text-base leading-relaxed text-emerald-500 font-bold"),b.push(e.jsx(k,{children:e.jsx("p",{className:f,children:W(d)})},`p-${b.length}`)),E=[]}};for(let d=0;d<z.length;d++){const f=z[d],g=f.trim(),A=g.includes("0000.2Void>>"),C=g.includes("【插入结束】")||g.includes("【插入結束】")||g.includes("[INSERTION_END]");if(A){B(),T=!0,D=[],D.push(f),C&&(T=!1,b.push(e.jsx(F,{lines:[...D]},`void-${d}`)),D=[]);continue}if(T){D.push(f),C&&(T=!1,b.push(e.jsx(F,{lines:[...D]},`void-${d}`)),D=[]);continue}const R=g.match(/^\[\[BLUE::(.*?)\]\]$/),V=g.match(/^\[\[DANGER::(.*?)\]\]$/),_=g.match(/^\[\[VOID_VISION::(.*?)\]\]$/),P=g==="[[DIVIDER]]",O=/\[\[IMAGE::(.*?)::(.*?)\]\]/.test(g);if(R||V||_||P||O||!g){if(B(),R){const I=s?`mb-6 md:mb-8 text-justify indent-8 md:indent-12 text-sm md:text-base leading-relaxed text-blue-600 font-bold ${y(i)}`:`mb-6 md:mb-8 text-justify indent-8 md:indent-12 text-sm md:text-base leading-relaxed text-blue-400 font-bold ${y(i)}`;b.push(e.jsx(k,{children:e.jsx("p",{className:I,children:W(R[1])})},`blue-${d}`))}else if(V){const I=s?`mb-6 md:mb-8 text-justify indent-8 md:indent-12 text-sm md:text-base leading-relaxed text-red-600 font-black animate-crash origin-left ${y(i)}`:`mb-6 md:mb-8 text-justify indent-8 md:indent-12 text-sm md:text-base leading-relaxed text-red-500 font-black animate-crash origin-left ${y(i)}`;b.push(e.jsx(k,{children:e.jsx("p",{className:I,children:W(V[1])})},`danger-${d}`))}else if(_){const I=_[1],L=I.includes("█");b.push(e.jsx(k,{className:"my-8 w-full max-w-2xl mx-auto",children:e.jsxs("div",{className:"relative border-y border-fuchsia-900/50 bg-black/80 p-6 backdrop-blur-sm overflow-hidden group select-none shadow-[0_0_30px_-10px_rgba(192,38,211,0.3)]",children:[e.jsx("div",{className:"absolute inset-0 bg-fuchsia-900/10 opacity-0 group-hover:opacity-20 transition-opacity"}),e.jsx("div",{className:"absolute top-0 left-0 w-0.5 h-full bg-fuchsia-500/50 box-shadow-[0_0_10px_rgba(217,70,239,0.8)]"}),e.jsx("div",{className:"absolute top-0 right-0 w-0.5 h-full bg-fuchsia-500/50 box-shadow-[0_0_10px_rgba(217,70,239,0.8)]"}),e.jsxs("div",{className:"flex items-center justify-between mb-4 border-b border-fuchsia-900/30 pb-2",children:[e.jsxs("div",{className:"text-[10px] font-mono text-fuchsia-600 tracking-[0.2em] flex items-center gap-2",children:[e.jsx(ce,{size:12,className:"animate-pulse"})," RETINAL_PROJECTION"]}),e.jsx("div",{className:"text-[10px] font-black font-mono bg-fuchsia-100 text-fuchsia-950 px-2 py-0.5 tracking-widest shadow-[0_0_15px_rgba(255,255,255,0.6)] animate-pulse",children:"SOURCE: VOID"})]}),e.jsx("div",{className:"relative z-10",children:e.jsxs("div",{className:`
                                        text-center leading-relaxed tracking-wide
                                        ${L?"text-fuchsia-500 font-mono text-sm md:text-base break-all animate-shake-violent opacity-70 drop-shadow-[0_0_5px_rgba(232,121,249,0.8)]":"text-white font-serif italic text-lg md:text-xl drop-shadow-[0_0_8px_rgba(255,255,255,0.9)]"}
                                    `,children:['"',I,'"']})}),e.jsx("div",{className:"absolute top-0 left-0 w-full h-[2px] bg-white/30 shadow-[0_0_15px_rgba(255,255,255,1)] animate-scanline pointer-events-none mix-blend-overlay"})]})},`void-vis-${d}`))}else if(P)b.push(e.jsx(k,{children:e.jsxs("div",{className:"my-12 flex items-center justify-center gap-4 opacity-50 select-none",children:[e.jsx("div",{className:"h-px bg-ash-light flex-1 bg-gradient-to-r from-transparent via-ash-light to-transparent"}),e.jsx(G,{size:16,className:"text-ash-light animate-pulse"}),e.jsx("div",{className:"h-px bg-ash-light flex-1 bg-gradient-to-r from-transparent via-ash-light to-transparent"})]})},`div-${d}`));else if(O){const I=g.match(/\[\[IMAGE::(.*?)::(.*?)\]\]/);if(I){const[L,te,U]=I;b.push(e.jsx(k,{className:"my-12 flex flex-col items-center w-full",children:e.jsxs("div",{className:"relative border-4 border-ash-light p-2 bg-ash-dark max-w-full shadow-hard",children:[e.jsx("img",{src:te,alt:U,className:"relative max-h-[600px] w-auto object-cover block grayscale-[20%] hover:grayscale-0 transition-all duration-500"}),e.jsx("div",{className:"absolute inset-0 bg-halftone opacity-20 pointer-events-none"}),e.jsxs("div",{className:"absolute bottom-4 right-4 bg-ash-light text-ash-black px-3 py-1 text-[10px] font-mono font-bold border-2 border-ash-black flex items-center gap-2 uppercase",children:[e.jsx(me,{size:12})," ",U]})]})},`img-${d}`))}}continue}E.push(g)}return B(),b};return e.jsxs("div",{className:"flex h-full relative overflow-hidden bg-retro-paper text-zinc-950",children:[n&&e.jsx("div",{className:"fixed inset-0 bg-black/50 backdrop-blur-[1px] z-10 md:hidden animate-fade-in",onClick:()=>a(!1)}),e.jsxs("aside",{className:`absolute md:relative z-20 h-full bg-ash-black border-r-4 border-ash-dark transition-all duration-300 ease-in-out flex flex-col shadow-2xl md:shadow-none ${n?"w-72 translate-x-0":"w-0 -translate-x-full md:w-0 md:-translate-x-0 overflow-hidden"}`,children:[e.jsxs("div",{className:`p-4 border-b-2 border-ash-gray bg-ash-black text-ash-light flex justify-between items-center shrink-0 ${h?"border-dashed":""}`,children:[e.jsxs("button",{onClick:u,className:"flex items-center gap-2 text-xs font-mono hover:text-ash-gray transition-colors",children:[e.jsx(X,{size:14})," ",t==="en"?"FILE_LIST":"文件列表"]}),e.jsx("div",{className:"text-[10px] font-mono opacity-50 truncate max-w-[100px]",children:t==="en"?r.titleEn:r.title})]}),e.jsx("div",{className:"overflow-y-auto flex-1 p-0",children:r.chapters.map((x,j)=>{var E;const z=((E=x.translations[t])==null?void 0:E.title)||x.translations["zh-CN"].title,b=x.status==="locked";return e.jsxs("button",{onClick:()=>{b||(o(j),window.innerWidth<768&&a(!1))},disabled:b,className:`w-full text-left p-4 text-xs font-mono border-b border-ash-dark transition-none group relative overflow-hidden ${j===l?h?"bg-blue-950/50 text-blue-200 border-blue-500/50":"bg-ash-light text-ash-black":b?"bg-ash-dark/10 text-ash-gray cursor-not-allowed":"text-ash-gray hover:bg-ash-dark hover:text-ash-white"}`,children:[e.jsx("div",{className:"relative z-10",children:e.jsxs("div",{className:"flex justify-between items-start",children:[e.jsxs("span",{className:`font-bold truncate uppercase max-w-[85%] ${h&&j===l?"legacy-text":""}`,children:[j===l&&e.jsx("span",{className:"mr-2",children:">"}),z]}),b&&e.jsx(Y,{size:12,className:"opacity-70"})]})}),b&&e.jsx("div",{className:"absolute inset-0 bg-[repeating-linear-gradient(45deg,transparent,transparent_5px,rgba(0,0,0,0.2)_5px,rgba(0,0,0,0.2)_10px)] pointer-events-none z-0"})]},x.id)})})]}),!n&&e.jsx("button",{onClick:()=>a(!0),className:"absolute top-4 left-4 z-10 p-2 bg-ash-black text-ash-light border-2 border-ash-light hover:bg-ash-light hover:text-ash-black shadow-hard",children:e.jsx(he,{size:20})}),e.jsx("main",{ref:m,className:"flex-1 overflow-y-auto scroll-smooth relative bg-ash-black",children:e.jsx("div",{className:`max-w-4xl mx-auto min-h-full bg-ash-black border-l-0 md:border-l-2 md:border-r-2 border-ash-dark/50 shadow-2xl relative animate-slide-in ${h?"border-dashed border-blue-900/30":""}`,children:p.status==="locked"?e.jsx("div",{className:"h-[80vh] flex flex-col items-center justify-center text-ash-gray p-8 text-center",children:e.jsxs("div",{className:"mb-6 p-6 border-4 border-dashed border-red-900/50 rounded-none bg-red-950/10 w-full max-w-md",children:[e.jsx(G,{size:64,className:"text-red-800 mb-4 mx-auto animate-pulse"}),e.jsx("h2",{className:"text-2xl font-black uppercase text-red-700 tracking-widest mb-2",children:t==="en"?"DATA_CORRUPTED":"数据损坏"}),e.jsx("p",{className:"font-mono text-sm text-red-900/70 mb-6",children:"ERR_READ_SECTOR // UNRECOVERABLE"}),e.jsxs("div",{className:"border-t border-red-900/30 pt-4 w-full",children:[e.jsxs("div",{className:"flex items-center justify-center gap-2 text-red-500 font-mono text-xs animate-pulse",children:[e.jsx(ie,{size:14,className:"animate-spin"}),e.jsx("span",{children:t==="en"?"REPAIRING...":t==="zh-TW"?"正在修復中...":"正在修复中..."})]}),e.jsx("div",{className:"w-full bg-red-950/50 h-1 mt-2 overflow-hidden",children:e.jsx("div",{className:"h-full bg-red-800/60 w-1/3 animate-[pulse_1s_cubic-bezier(0,0,0.2,1)_infinite] opacity-50"})})]})]})}):e.jsxs(e.Fragment,{children:[e.jsx("div",{className:`px-8 py-12 lg:px-16 border-b-4 border-double border-ash-gray bg-ash-black text-ash-light mt-12 ${h?"border-dashed border-blue-900/50":""}`,children:e.jsxs(k,{children:[e.jsxs("div",{className:`flex justify-between items-start mb-6 font-mono text-[10px] text-ash-gray uppercase tracking-widest ${h?"text-blue-500/70":""}`,children:[e.jsxs("span",{children:["SIDE_ARCHIVE // ",p.id]}),e.jsxs("span",{children:["FILE_INDEX: ",l+1]})]}),e.jsx("h1",{className:`text-3xl md:text-5xl font-black mb-6 uppercase tracking-tighter leading-tight ${h?"legacy-text text-blue-200":""}`,children:v.title}),e.jsxs("div",{className:`flex items-center gap-2 text-xs font-mono text-ash-gray bg-ash-dark inline-block px-3 py-1 border border-ash-gray ${h?"border-blue-900/50 bg-blue-950/20 text-blue-400":""}`,children:[h?e.jsx($,{size:12,className:"animate-pulse"}):e.jsx(K,{size:12}),e.jsx("span",{children:p.date})]})]})}),e.jsx("article",{className:`px-8 py-12 lg:px-16 max-w-none text-ash-light font-serif leading-loose tracking-wide ${h?"font-mono":y(i)}`,children:N(v.content)}),e.jsx("div",{className:`p-8 md:p-16 border-t-4 border-double border-ash-gray bg-ash-dark ${h?"border-dashed border-blue-900/30 bg-blue-950/10":""}`,children:e.jsxs("div",{className:"flex justify-between items-center gap-4",children:[e.jsxs("button",{onClick:()=>o(x=>Math.max(0,x-1)),disabled:l===0,className:"flex-1 flex items-center justify-center gap-2 px-6 py-4 border-2 border-ash-gray text-ash-gray hover:bg-ash-light hover:text-ash-black hover:border-ash-light disabled:opacity-20 disabled:hover:bg-transparent disabled:hover:text-ash-gray transition-colors uppercase font-bold text-sm font-mono",children:[e.jsx(oe,{size:16})," PREV"]}),e.jsxs("button",{onClick:()=>o(x=>Math.min(r.chapters.length-1,x+1)),disabled:l===r.chapters.length-1,className:"flex-1 flex items-center justify-center gap-2 px-6 py-4 border-2 border-ash-gray text-ash-gray hover:bg-ash-light hover:text-ash-black hover:border-ash-light disabled:opacity-20 disabled:hover:bg-transparent disabled:hover:text-ash-gray transition-colors uppercase font-bold text-sm font-mono",children:["NEXT ",e.jsx(q,{size:16})]})]})})]})},p.id)})]})},Re=({isOpen:r,onClose:c,language:u,isLightTheme:t})=>{const[s,i]=w.useState(M[0].id);if(!r)return null;const l=M.reduce((a,m)=>(a[m.group]||(a[m.group]=[]),a[m.group].push(m),a),{}),o=M.find(a=>a.id===s)||M[0],n=(o==null?void 0:o.translations[u])||(o==null?void 0:o.translations["zh-CN"]);return o?e.jsx("div",{className:"fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-[2px] p-4 animate-fade-in",onClick:c,children:e.jsxs("div",{className:`w-full max-w-3xl border-2 shadow-2xl relative overflow-hidden flex flex-col md:flex-row h-full max-h-[90vh] md:h-auto md:max-h-[85vh] ${t?"bg-white border-zinc-300":"bg-ash-black border-ash-dark"}`,onClick:a=>a.stopPropagation(),children:[e.jsx("button",{onClick:c,className:`absolute top-2 right-2 p-2 md:hidden z-50 ${t?"text-zinc-500 hover:text-black":"text-ash-gray hover:text-ash-light"}`,children:e.jsx(Z,{size:24})}),e.jsxs("div",{className:`w-full md:w-64 border-b-2 md:border-b-0 md:border-r-2 p-4 flex flex-col gap-2 overflow-y-auto shrink-0 no-scrollbar max-h-48 md:max-h-full ${t?"bg-zinc-50 border-zinc-200":"bg-ash-dark border-ash-gray/30"}`,children:[e.jsxs("div",{className:`text-[10px] font-mono uppercase mb-4 pb-2 border-b flex items-center gap-2 sticky top-0 z-10 ${t?"text-zinc-500 border-zinc-200 bg-zinc-50":"text-ash-gray border-ash-gray/30 bg-ash-dark"}`,children:[e.jsx(pe,{size:12})," ROOT/PERSONNEL_DB"]}),Object.entries(l).map(([a,m])=>e.jsxs("div",{className:"mb-2",children:[e.jsxs("div",{className:`flex items-center gap-2 text-[10px] font-bold mb-1 px-1 ${t?"text-zinc-600":"text-ash-light/70"}`,children:[e.jsx("span",{className:"opacity-50",children:"├─"}),e.jsx(Q,{size:10,className:"opacity-50"}),a]}),e.jsx("div",{className:`flex flex-col border-l border-dashed ml-3 pl-2 gap-1 py-1 ${t?"border-zinc-300":"border-ash-gray/20"}`,children:m.map(p=>{const v=p.translations[u].name,h=s===p.id;let N="";return t?N=h?"text-black bg-zinc-200 font-bold pl-3":"text-zinc-500 hover:text-black hover:bg-zinc-100 hover:pl-3":N=h?"text-ash-light bg-ash-gray/20 font-bold pl-3":"text-ash-gray hover:text-ash-light hover:bg-ash-gray/10 hover:pl-3",e.jsxs("button",{onClick:()=>i(p.id),className:`text-left text-xs font-mono py-1 px-2 flex items-center gap-2 transition-all duration-200 relative group/item ${N}`,children:[e.jsx("span",{className:`w-1.5 h-1.5 rounded-full ${p.isLocked?"bg-red-500/50":"bg-green-500/50"} ${h?"animate-pulse":""}`}),e.jsx("span",{className:"truncate",children:v}),p.isLocked&&e.jsx(H,{size:8,className:"ml-auto opacity-50"}),h&&e.jsx("div",{className:`absolute left-0 top-0 bottom-0 w-0.5 ${t?"bg-black":"bg-ash-light"}`})]},p.id)})})]},a))]}),e.jsxs("div",{className:`flex-1 overflow-y-auto p-6 md:p-8 relative ${t?"bg-white":"bg-ash-black"}`,children:[e.jsx("div",{className:"absolute top-0 right-0 p-4 opacity-5 pointer-events-none",children:e.jsx(le,{size:200,strokeWidth:1})}),e.jsx("button",{onClick:c,className:`absolute top-2 right-2 p-2 hidden md:block z-20 ${t?"text-zinc-400 hover:text-zinc-900":"text-ash-gray hover:text-ash-light"}`,children:e.jsx(Z,{size:20})}),o.isLocked?e.jsxs("div",{className:"h-full flex flex-col items-center justify-center text-center opacity-80 min-h-[200px]",children:[e.jsxs("div",{className:`border p-8 max-w-xs relative ${t?"border-red-200 bg-red-50":"border-red-900/50 bg-red-950/10"}`,children:[e.jsx("div",{className:"absolute top-0 left-0 w-2 h-2 border-t border-l border-red-800"}),e.jsx("div",{className:"absolute top-0 right-0 w-2 h-2 border-t border-r border-red-800"}),e.jsx("div",{className:"absolute bottom-0 left-0 w-2 h-2 border-b border-l border-red-800"}),e.jsx("div",{className:"absolute bottom-0 right-0 w-2 h-2 border-b border-r border-red-800"}),e.jsx(Y,{size:48,className:"text-red-800 mx-auto mb-4 animate-pulse"}),e.jsx("h2",{className:"text-xl font-black text-red-700 uppercase tracking-widest mb-1",children:"ACCESS DENIED"}),e.jsx("p",{className:"text-[10px] font-mono text-red-900 uppercase",children:"Encrypted File // Auth Missing"})]}),e.jsxs("div",{className:`mt-8 font-mono text-xs ${t?"text-zinc-400":"text-ash-gray/50"}`,children:[">"," ID: ",o.id.toUpperCase(),e.jsx("br",{}),">"," STATUS: LOCKED"]})]}):e.jsxs("div",{className:"relative z-10 space-y-6 animate-fade-in pt-4 md:pt-0",children:[e.jsxs("div",{className:`border-b pb-4 ${t?"border-zinc-200":"border-ash-gray/30"}`,children:[e.jsx("h2",{className:`text-2xl md:text-3xl font-black uppercase tracking-tighter mb-1 ${t?"text-zinc-900":"text-ash-light"}`,children:n.name}),e.jsxs("div",{className:`flex flex-wrap items-center gap-2 text-xs font-mono ${t?"text-zinc-500":"text-ash-gray"}`,children:[e.jsx("span",{className:`px-1 border ${t?"bg-zinc-100 border-zinc-300 text-zinc-700":"text-ash-light bg-ash-dark border-ash-gray/50"}`,children:n.enName}),e.jsxs("span",{children:["// ",n.role]}),e.jsxs("span",{className:"ml-auto opacity-50",children:["ID: ",o.id.toUpperCase()]})]})]}),e.jsx("div",{className:"flex flex-wrap gap-2",children:n.tags.map(a=>e.jsxs("span",{className:`px-2 py-1 border rounded-full text-[10px] font-mono ${t?"border-zinc-300 text-zinc-600":"border-ash-gray/50 text-ash-gray"}`,children:["#",a]},a))}),n.quote&&e.jsxs("div",{className:`border-l-2 pl-3 py-1 text-sm italic font-serif ${t?"border-zinc-400 text-zinc-600":"border-ash-light text-ash-light/80"}`,children:['"',n.quote,'"']}),e.jsx("div",{className:`space-y-4 text-sm font-mono leading-relaxed border-t border-dashed pt-4 pb-8 md:pb-0 ${t?"text-zinc-700 border-zinc-200":"text-ash-gray/90 border-ash-gray/30"}`,children:n.description.map((a,m)=>{const p=a.split("**");return e.jsx("div",{className:a.startsWith("•")||a.startsWith("> ")?"pl-4":"",children:p.map((v,h)=>h%2===1?e.jsx("span",{className:`font-bold px-1 ${t?"bg-zinc-200 text-black":"text-ash-light bg-ash-dark/50"}`,children:v},h):v)},m)})})]})]})]})}):null},Ve=({onComplete:r,language:c,volumeId:u})=>{const[t,s]=w.useState(0),i=u==="VOL_MEMORIES";w.useEffect(()=>{const o=setTimeout(()=>s(1),500),n=setTimeout(()=>s(2),2e3),a=setTimeout(()=>s(3),3500),m=setTimeout(r,4e3);return()=>{clearTimeout(o),clearTimeout(n),clearTimeout(a),clearTimeout(m)}},[r]);const l={"zh-CN":{accessing:"访问记忆扇区...",decompressing:"解压碎片数据",syncing:"神经同步中",complete:"重构完成",rain_init:"正在回溯时间轴...",rain_mem:"检索关键节点：[雨]",rain_sync:"VoidOS部署中"},"zh-TW":{accessing:"訪問記憶扇區...",decompressing:"解壓碎片數據",syncing:"神經同步中",complete:"重構完成",rain_init:"正在回溯時間軸...",rain_mem:"檢索關鍵節點：[雨]",rain_sync:"VoidOS部署中"},en:{accessing:"ACCESSING_MEMORY_SECTOR...",decompressing:"DECOMPRESSING_FRAGMENTS",syncing:"NEURAL_SYNC_IN_PROGRESS",complete:"RECONSTRUCTION_COMPLETE",rain_init:"REWINDING_TIMELINE...",rain_mem:"SEARCHING_NODE: [RAIN]",rain_sync:"DEPLOYING_VOID_OS"}}[c];return i?e.jsxs("div",{className:"fixed inset-0 z-[99999] bg-slate-950 text-cyan-100 overflow-hidden flex flex-col items-center justify-center font-mono cursor-none",children:[e.jsx("button",{onClick:r,className:"absolute top-4 right-4 z-[100000] text-[10px] font-mono border border-cyan-400/30 text-cyan-400 px-2 py-1 hover:bg-cyan-400 hover:text-slate-900 transition-colors opacity-70 hover:opacity-100 cursor-pointer",children:"[SKIP_MEMORY]"}),e.jsx("div",{className:`absolute inset-0 bg-gradient-to-b from-slate-900 via-slate-950 to-black transition-opacity duration-1000 ${t>0?"opacity-100":"opacity-0"}`}),e.jsx("div",{className:"absolute inset-0 overflow-hidden pointer-events-none opacity-40",children:Array.from({length:40}).map((o,n)=>e.jsx("div",{className:"absolute w-[1px] bg-gradient-to-b from-transparent via-cyan-400 to-transparent animate-data-rain",style:{height:`${30+Math.random()*50}px`,left:`${Math.random()*100}%`,top:"-20%",animationDuration:`${.8+Math.random()*1.5}s`,animationDelay:`${Math.random()*2}s`}},n))}),e.jsxs("div",{className:"relative z-10 flex flex-col items-center gap-12",children:[e.jsxs("div",{className:"relative w-48 h-48 flex items-center justify-center",children:[e.jsx("div",{className:`absolute inset-0 border border-cyan-500/20 rounded-full transition-all duration-1000 ${t>=1?"scale-100 opacity-100 rotate-180":"scale-50 opacity-0 rotate-0"}`}),e.jsx("div",{className:`absolute inset-4 border border-cyan-500/30 rounded-full border-dashed transition-all duration-1000 ${t>=1?"scale-100 opacity-100 -rotate-180":"scale-90 opacity-0 rotate-0"}`}),e.jsx("div",{className:`transition-all duration-700 absolute ${t===1?"scale-100 opacity-100":"scale-50 opacity-0"}`,children:e.jsx(ge,{size:48,className:"text-cyan-400"})}),e.jsx("div",{className:`transition-all duration-700 absolute ${t===2?"scale-100 opacity-100":"scale-50 opacity-0"}`,children:e.jsx(J,{size:56,className:"text-cyan-200"})}),e.jsx("div",{className:`transition-all duration-700 absolute ${t===3?"scale-125 opacity-100 blur-sm":"scale-50 opacity-0"}`,children:e.jsx(xe,{size:64,className:"text-white fill-white/20"})})]}),e.jsxs("div",{className:"text-center space-y-4 h-16",children:[e.jsxs("div",{className:"text-xl md:text-2xl font-light tracking-[0.3em] text-cyan-100/90 font-serif italic",children:[t===0&&"",t===1&&l.rain_init,t===2&&l.rain_mem,t===3&&l.rain_sync]}),e.jsx("div",{className:"w-32 h-[1px] bg-cyan-900/50 mx-auto overflow-hidden",children:e.jsx("div",{className:"h-full bg-cyan-400 shadow-[0_0_10px_rgba(34,211,238,0.8)] transition-all duration-300 ease-linear",style:{width:`${t/3*100}%`}})})]})]}),e.jsx("div",{className:`absolute inset-0 bg-white pointer-events-none transition-opacity duration-1000 ease-in-out ${t===3?"opacity-100":"opacity-0"}`})]}):e.jsxs("div",{className:"fixed inset-0 z-[99999] bg-ash-black text-ash-light overflow-hidden flex flex-col items-center justify-center font-mono cursor-none",children:[e.jsx("button",{onClick:r,className:"absolute top-4 right-4 z-[100000] text-[10px] font-mono border border-blue-400/30 text-blue-400 px-2 py-1 hover:bg-blue-400 hover:text-black transition-colors opacity-70 hover:opacity-100 cursor-pointer",children:"[SKIP_DIVE]"}),e.jsx("div",{className:`absolute inset-0 bg-gradient-to-b from-blue-950/20 to-black transition-opacity duration-1000 ${t>0?"opacity-100":"opacity-0"}`}),e.jsx("div",{className:"absolute inset-0 overflow-hidden pointer-events-none opacity-30",children:Array.from({length:20}).map((o,n)=>e.jsx("div",{className:"absolute top-[-100%] text-[10px] text-blue-500/50 writing-vertical-rl animate-data-rain",style:{left:`${Math.random()*100}%`,animationDuration:`${1+Math.random()*2}s`,animationDelay:`${Math.random()*1}s`,fontSize:`${10+Math.random()*8}px`},children:Math.random()>.5?"010101":"A9F3C2"},n))}),e.jsxs("div",{className:"relative z-10 flex flex-col items-center gap-8",children:[e.jsxs("div",{className:"relative w-32 h-32 md:w-48 md:h-48 flex items-center justify-center",children:[t>=1&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"absolute inset-0 border border-blue-500/30 rounded-full animate-ping",style:{animationDuration:"2s"}}),e.jsx("div",{className:"absolute inset-0 border border-cyan-400/20 rounded-full animate-ping",style:{animationDuration:"2s",animationDelay:"0.5s"}})]}),e.jsxs("div",{className:`transition-all duration-700 ${t===2?"scale-125 text-white":"scale-100 text-blue-400"}`,children:[t===0&&e.jsx(ne,{size:48,className:"animate-pulse"}),t===1&&e.jsx(be,{size:48,className:"animate-bounce"}),t>=2&&e.jsx(de,{size:64})]})]}),e.jsxs("div",{className:"text-center space-y-2",children:[e.jsxs("div",{className:"text-xl md:text-3xl font-black uppercase tracking-widest text-blue-200",children:[t===0&&l.accessing,t===1&&l.decompressing,t>=2&&l.syncing]}),e.jsx("div",{className:"w-48 md:w-64 h-1 bg-blue-900/50 mx-auto mt-4 overflow-hidden",children:e.jsx("div",{className:"h-full bg-blue-400 shadow-[0_0_10px_rgba(96,165,250,0.8)] transition-all duration-300 ease-linear",style:{width:`${t/3*100}%`}})}),e.jsxs("div",{className:"text-[10px] text-blue-500/60 font-mono mt-1",children:["SECTOR_MEM // ",t*33,"%"]})]})]}),e.jsx("div",{className:`absolute inset-0 bg-white pointer-events-none transition-opacity duration-500 ${t===3?"opacity-100":"opacity-0"}`})]})},Le=({language:r,isLightTheme:c,onVolumeChange:u,readerFont:t})=>{const[s,i]=w.useState("volumes"),[l,o]=w.useState(null),[n,a]=w.useState(0),[m,p]=w.useState(!1),[v,h]=w.useState(!1),N=b=>{o(b),u(b.id),h(!0)},x=()=>{h(!1),i("chapters")},j=b=>{a(b),i("reader")},z=()=>{o(null),u(null),i("volumes")};return v&&l?e.jsx(Ve,{onComplete:x,language:r,volumeId:l.id}):s==="volumes"?e.jsxs(e.Fragment,{children:[e.jsx(ze,{volumes:Se,onSelectVolume:N,onOpenCharModal:()=>p(!0),language:r,isLightTheme:c}),e.jsx(Re,{isOpen:m,onClose:()=>p(!1),language:r,isLightTheme:c})]}):s==="chapters"&&l?e.jsx(_e,{volume:l,onBack:z,onSelectChapter:j,language:r,isLightTheme:c}):s==="reader"&&l?e.jsx(Ce,{volume:l,initialChapterIndex:n,onBack:()=>i("chapters"),language:r,isLightTheme:c,readerFont:t}):null};export{Le as default};
